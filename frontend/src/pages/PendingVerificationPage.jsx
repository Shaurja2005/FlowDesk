  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-base px-4">
      <div className="max-w-md w-full bg-surface p-8 rounded-2xl border border-theme shadow-card text-center">
        ...
        <h2 className="text-2xl font-bold text-primary-content mb-2">Check your email</h2>
        <p className="text-secondary-content mb-6">
          We've sent a verification link to <span className="text-primary-content font-medium">{email}</span>. 
        ...
        <div className="mt-8 pt-6 border-t border-theme">
          <p className="text-sm text-muted-content mb-3">Didn't receive the email?</p>
          <button 
            ...
            className={`flex items-center justify-center gap-2 w-full px-4 py-2 text-sm font-medium rounded-lg transition-colors ${
              cooldown > 0 || loading
                ? 'bg-elevated text-muted-content cursor-not-allowed'
                : 'bg-elevated hover:bg-dark-600 text-primary-content'
            }`}
          >
